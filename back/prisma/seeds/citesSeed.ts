type city = [number, string, string, string, string, number];
const cites: city[] = [
  [
    1,
    'Sant Julia de Loria',
  ...
  [
    ...
    'المنطقة الشمالية',
    'Al Mintaqah cendres Shamaliyah',
    '10',
    21,
  ],
  ...
  [
    ...
    'Nichollstown et les îles Berry',
    '32',
    28,
  ],
  ...
  [
    ...
    "Libertador General Bernardo O'Higgins",
    "Libertador Général Bernardo O'Higgins",
    '08',
    41,
  ],
  ...
  [
    ...
    'Magallanes y de la Antartica Chilena',
    "Magallanes et de l'Antarctique Chilena",
    '10',
    41,
  ],
...
export const citesSeed = async (prisma: PrismaClient) => {
  let array = cites.map((elem, i) => ({
    id: elem[0].toString(),
    nameEn: elem[1],
    nameAr: elem[2],
    nameFr: elem[3],
    code: elem[4],
    countryId: elem[5].toString(),
  }));
