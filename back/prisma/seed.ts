...
async function main() {
  ...
  let publishinghouseIds = [publishingHouse1.id, publishingHouse2.id, publishingHouse3.id, publishingHouse4.id, publishingHouse5.id, publishingHouse6.id, publishingHouse7.id, publishingHouse8.id]
  ...
  let articlesIds = [article1.id, article2.id, article3.id, article4.id, article5.id, article6.id, article7.id, article8.id, article9.id, article10.id, article11.id, article12.id, article13.id, article14.id, article15.id, article16.id, article17.id, article18.id, article19.id, article20.id]
...
let articlesByBranchIds=[articlesBybranch1.id,articlesBybranch2.id,articlesBybranch3.id,articlesBybranch4.id,articlesBybranch5.id,articlesBybranch6.id,articlesBybranch7.id,articlesBybranch8.id,articlesBybranch9.id,articlesBybranch10.id,articlesBybranch11.id,articlesBybranch12.id,articlesBybranch13.id,articlesBybranch14.id,articlesBybranch15.id,articlesBybranch16.id,articlesBybranch17.id,articlesBybranch18.id,articlesBybranch19.id,articlesBybranch20.id,]
  ...
  for (let i = 0; i < articles.length; i += 2) {
    rating.push(
      await prisma.rating.create({
        data: {
          articleByBranchId: articlesByBranchIds[Math.floor(Math.random() * articlesByBranchIds.length)],
