            ...
            <div className="row gutters">
              ...
              <Form>
                ...
                <div className="d-flex justify-content-center align-items-center">
                  <Button onClick={submitEditProfile} type="submit" className="d-flex justify-content-center align-items-center w-50" style={{ backgroundColor: "#956EB1", borderColor: "#956EB1" }}>
                    {editMode ? "Save update" : "Update"}
                  </Button>
                </div>
              </Form>
