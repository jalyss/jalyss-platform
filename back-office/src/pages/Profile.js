...
function Profile() {
  ...
  useEffect(() => {
    if (employeeStore.employee)
      setUser(employeeStore.employee)
  ...
  return (
    !openCrop?(<div className="container d-flex justify-content-center align-items-center">
  ...
  <div className="card h-100 ">
          ...
          <div className="card-body">
              ...
              >
                X
                      ...
                      <h5 className="user-name fw-bold mt-3">{user?.fullNameEn}</h5>
      ...
      <Row className="mb-3">
        ...
        <div className="d-flex flex-column">
         ...
         />) :
          <Form.Label className="fw-bold">{user?.fullNameAr}</Form.Label>}
          </div>
        </Form.Group>
        ...
        <div className="d-flex flex-column">
          ...
          {editMode? (
           ...
           onChange={handleChange}
         />) :
          <Form.Label className="fw-bold">{user?.fullNameEn}</Form.Label>}
          </div>
        </Form.Group>
      ...
      <div className="d-flex flex-column">
        <Form.Label>Email</Form.Label>{editMode?(
          <input
          required
          class="form-control mt-2"
          type="email"
      ...
      <Row className="mb-3">
        ...
        <div className="d-flex flex-column">
          ...
          <Form.Label className="fw-bold">{user?.branch?.name}</Form.Label>}
          </div>
        </Form.Group>
        ...
        >
          ...
          <Form.Label className="fw-bold">{user?.role?.nameAr}</Form.Label>}
          </div>
        </Form.Group>
...
{editMode && (<Button
            variant="outlined"
            // startIcon={<Cancel />}
            style={{backgroundColor:"#956EB1" , borderColor:"#956EB1" , color:"#fff",fontSize:"17px"}}
            onClick={() => setEditMode(false)}
          >
            CANCEL
          </Button>)}
      <Button onClick={submitEditProfile} type="submit" className="d-flex justify-content-center align-items-center"  style={{backgroundColor:"#956EB1" , borderColor:"#956EB1",fontSize:"17px"}}>
