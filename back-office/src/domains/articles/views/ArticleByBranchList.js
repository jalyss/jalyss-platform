...
import { fetchArticles, addTransactionStock,  updateArticleByBranch } from '../../../store/article'
...
function ArticleByBranchList() {
    ...
    const [mvtBranch, setMvtBranch] = useState({ quantity: 1, status: 'pending' });
    ...
    const handleMvtChange = (e) => {
        ...
        setMvtBranch((MvtBranch) => ({ ...MvtBranch, [name]: name === 'quantity' ? + value : value }))
    }
    ...
    const handleUpdate = (event) => {
        ...
        delete aux.rating
        console.log(aux);
        dispatch(updateArticleByBranch(aux))
            .then(res => {
                if (!res.error) {
                    showSuccessToast(' transmission successfully ')
                    setOpen(false)
                    ...
                    <Box onSubmit={submitCreate} component='form'>
                        <DialogContent>
                            ...
                            >
                                ...
                                <FormControl sx={{ mt: 2, minWidth: 120 }} required error={!mvtBranch.branchSenderId} >
                                ...
                                <FormControl sx={{ mt: 2, minWidth: 120 }} required>
                                    ...
                                    <TextField id="outlined-basic" label="الكمية" variant="outlined" min="1"
                                        max="10000"
                        ...
                        <DialogActions sx={{ display: 'flex', justifyContent: 'center' }}>
                            <Button onClick={handleClose} color='secondary' variant="contained" type='button'>غلق</Button>

                            <Button type='submit' onSubmit={submitCreate} variant="contained" color="primary">
                    ...
                    <div>
                        ...
                        <DialogContent>
                            ...
                            <FormControl sx={{ mt: 2, minWidth: 120 }} required>
                                ...
                                <TextField id="outlined-basic" label="السعر" variant="outlined" min="1"
                                    max="10000"
                        ...
                        <DialogActions sx={{ display: 'flex', justifyContent: 'center' }}>
                        <Button onClick={handleCloseDialogPrice} color='secondary' variant="contained" type='button'>غلق</Button>
                    ...
                    <div className='card'>
                        ...
                        <div className='d-flex justify-content-center'>
                            <div className=''>
                                <div className='d-flex'>
                                    <div style={{ width: 100 }}><h6>Branch</h6></div>
                                    <div style={{ width: 50 }}><h6>Qte</h6></div>
                                    <div style={{ width: 50 }}><h6>Price</h6></div>
                                </div>
                                {element.ArticlesByBranch.map((elem, j) => (
                                    <div className='d-flex py-2'>
                                        ...
                                        <Button
                                            variant='contained'
                                            color='warning'
                                            style={{ height: 25, width: 80, fontSize: 10, padding: 0 }}
                                            onClick={() => {
                                                console.log(elem);
                        ...
                        <div className='d-flex justify-content-center align-items-end  h-100'>
                            <div className='border d-flex justify-content-center w-100'>
                                <Button variant='outlined' onClick={() => handleClickOpen(element.id)} >Add transaction</Button>
                            </div>
                        </div>
